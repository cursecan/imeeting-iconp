            ...
            <div className="">
                <div className="fixed inset-0 top-0 bg-white z-10">
                    <div className="relative h-screen overflow-scroll">
                        <div className="px-[20px] py-[12px] flex items-center border-b shadow-sm">
                            <div className="flex items-center gap-[12px]">
                                ...
                                <span className="text-[22px] font-medium uppercase">Dashboard</span>
                            </div>
                        ...
                        <div className="p-[20px] space-y-[14px]">
                            <div className="">
                                <div className="form-control">
                                    <label htmlFor="" className=" opacity-80">Periode</label>
                                    <DatePicker 
                                        selected={startDate}
                                                ...
                                                data[0].data.map((i, index) => {
                                                    return (
                                                        <div className="" key={index}>
                                                            <div className="flex items-center font-semibold uppercase text-gray-500 gap-[12px] py-4">
                                                                    ...
                                                                    i.detailSummary.map((j, index2) => {
                                                                        return (
                                                                            <div className="rounded-xl overflow-hidden" key={index2}>
                                                                                <div className="bg-gray-200 p-[12px] space-y-[4px]">
                                                                                    <div className="text-sm">{j.roomName}</div>
                                                                                    <div className="flex items-center justify-between py-[8px]">
                                                                                        <div className="flex-1 text-xl font-bold">
                                                                                            <div className="text-xs font-normal">Presentase Pemakaian</div>
                                                                                            <div className="">
                                                                                    ...
                                                                                    <div className="text-xl font-bold">
                                                                                        <div className="text-xs font-normal">Nominal Konsumsi</div>
                                                                                    ...
                                                                                    <div className="">
                                                                                        {
                                                                                            j.totalConsumption.map((n, index3) => {
                                                                                                return (
                                                                                                    <div className="flex h-[31px] text-xs items-center" key={index3}>
                                                                                                        <div className="flex-1 text-[10px] font-medium">{n.name}</div>
                                                                                                        <div className="flex-1">
                                                                                                            <div className="">{n.totalPackage}</div>
                                                                                                            <div className="h-[8px] rounded-xl bg-sky-600" style={{width: `${parseInt(n.totalPackage)/j.totalConsumption.reduce((total, m) => total+parseInt(m.totalPackage), 0)*100}%`}}></div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                )
                                                                                            })
